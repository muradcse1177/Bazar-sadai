            ...
            <div class="card">
                <div class="card-body cardBody">
                    <div class="col-sm-12">
                        ...
                        <p class="card-text">ফিসঃ {{en2bn($diagnosticCenter->fees.' টাকা')}} </p>
                        <p class="card-text">টেস্ট করার সময়ঃ {{$diagnosticCenter->intime.' '.$diagnosticCenter->intimezone.'-'.$diagnosticCenter->outtime.' '.$diagnosticCenter->outtimezone}} </p>
