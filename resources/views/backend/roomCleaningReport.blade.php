...
@section('title', 'ক্লিনার রিপোর্ট')
@section('page_header', 'ক্লিনার ব্যবস্থাপনা')
@section('roomCleaningReport','active')
@section('extracss')
@endsection
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="divform">
                    {{ Form::open(array('url' => 'cleaningReportListByDate',  'method' => 'post')) }}
                    {{ csrf_field() }}
                    <div class="box-body">
