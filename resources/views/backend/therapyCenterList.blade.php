...
@section('title','থেরাপি সেন্টার')
@section('page_header', 'থেরাপি সেন্টার ব্যবস্থাপনা')
@section('serviceMainLi','active menu-open')
@section('medicalMainLi','active menu-open')
@section('therapyCenterList','active')
@section('content')
    ...
    <div class="row">
            ...
            <div class="box box-primary">
                ...
                <div class="divform" style="display:none">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="">থেরাপি সেন্টার নাম </label>
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">থেরাপি সেন্টার লিস্ট </h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body table-responsive">
                    <table class="table table-bordered">
                        <tr>
                            <th>থেরাপি সার্ভিস </th>
                            <th>থেরাপি সেন্টার </th>
                            <th>টুল</th>
                        </tr>
                        @foreach($therapy_centers as $therapy_center)
                            <tr>
                                <td> {{$therapy_center->name}} </td>
                                <td> {{$therapy_center->center_name}} </td>
                                <td class="td-actions text-center">
                                    <button type="button" rel="tooltip" class="btn btn-success edit" data-id="{{$therapy_center->id}}">
                                        <i class="fa fa-edit"></i>
                                    </button>
                                    <button type="button" rel="tooltip"  class="btn btn-danger delete" data-id="{{$therapy_center->id}}">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    {{ Form::open(array('url' => 'deleteTherapyCenter',  'method' => 'post')) }}
                                    {{ csrf_field() }}
