...
@section('title','ডিপার্টমেন্ট')
@section('page_header', 'ডিপার্টমেন্ট ব্যবস্থাপনা')
@section('serviceMainLi','active menu-open')
@section('medicalMainLi','active menu-open')
@section('departmentList','active')
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="divform" style="display:none">
                    {{ Form::open(array('url' => 'insertMedDepartment',  'method' => 'post')) }}
                    {{ csrf_field() }}
                    <div class="box-body">
                        <div class="form-group">
                            <label for="">ডিপার্টমেন্ট নাম </label>
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">ডিপার্টমেন্ট লিস্ট </h3>
                </div>
                <!-- /.box-header -->
                        ...
                        @foreach($departmentLists as $departmentList)
                            <tr>
                                ...
                                <td class="td-actions text-center">
                                    <button type="button" rel="tooltip" class="btn btn-success edit" data-id="{{$departmentList->id}}">
                                        <i class="fa fa-edit"></i>
                                    </button>
                                    <button type="button" rel="tooltip"  class="btn btn-danger delete" data-id="{{$departmentList->id}}">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    {{ Form::open(array('url' => 'deleteMedDepartment',  'method' => 'post')) }}
                                    {{ csrf_field() }}
