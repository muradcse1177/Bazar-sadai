...
@section('title','ডায়াগনস্টিক টেস্ট')
@section('page_header', 'ডায়াগনস্টিক টেস্ট ব্যবস্থাপনা')
@section('serviceMainLi','active menu-open')
@section('medicalMainLi','active menu-open')
@section('diagnosticTestList','active')
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="divform" style="display:none">
                    {{ Form::open(array('url' => 'insertDiagnosticTest',  'method' => 'post')) }}
                    {{ csrf_field() }}
                    <div class="box-body">
                        <div class="form-group">
                            <label for="">ডায়াগনস্টিক টেস্ট নাম </label>
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">ডায়াগনস্টিক টেস্ট  লিস্ট </h3>
                </div>
                <!-- /.box-header -->
                        ...
                        @foreach($diagnosticTests as $diagnosticTest)
                            <tr>
                                ...
                                <td class="td-actions text-center">
                                    <button type="button" rel="tooltip" class="btn btn-success edit" data-id="{{$diagnosticTest->id}}">
                                        <i class="fa fa-edit"></i>
                                    </button>
                                    <button type="button" rel="tooltip"  class="btn btn-danger delete" data-id="{{$diagnosticTest->id}}">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    {{ Form::open(array('url' => 'deleteDiagnosticTest',  'method' => 'post')) }}
                                    {{ csrf_field() }}
