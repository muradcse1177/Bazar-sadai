...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="divform" style="display:none">
                    {{ Form::open(array('url' => 'insertCoach',  'method' => 'post')) }}
                    {{ csrf_field() }}
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="">কোচ নাম </label>
                            <input type="text" class="form-control coach" id="coach"  name="coach" placeholder="কোচ নাম লিখুন" required>
                        </div>
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">কোচ লিস্ট </h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body table-responsive">
                    <table class="table table-bordered">
                        ...
                        @foreach($transports_caoches as $transports_caoch)
                            <tr>
                                <td> {{$transports_caoch->name}} </td>
                                <td> {{$transports_caoch->coach_name}} </td>
                                <td class="td-actions text-center">
                                    <button type="button" rel="tooltip" class="btn btn-success edit" data-id="{{$transports_caoch->id}}">
                                        <i class="fa fa-edit"></i>
                                    </button>
                                    <button type="button" rel="tooltip"  class="btn btn-danger delete" data-id="{{$transports_caoch->id}}">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    {{ Form::open(array('url' => 'deleteCoach',  'method' => 'post')) }}
                                    {{ csrf_field() }}
