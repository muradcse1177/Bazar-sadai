        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="divform" style="display:none">
                    {{ Form::open(array('url' => 'insertTourBooking1Agent',  'method' => 'post','enctype'=> 'multipart/form-data')) }}
                    {{ csrf_field() }}
                    <div class="box-body">
                        <label>বুকিং</label>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    {{ Form::open(array('url' => 'deleteTourMainListAgent',  'method' => 'post')) }}
                                    {{ csrf_field() }}
