        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="divform" style="display:none">
                    {{ Form::open(array('url' => 'insertWard',  'method' => 'post')) }}
                    {{ csrf_field() }}
                    <div class="box-body">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    {{ Form::open(array('url' => 'deleteWard',  'method' => 'post')) }}
                                    {{ csrf_field() }}
