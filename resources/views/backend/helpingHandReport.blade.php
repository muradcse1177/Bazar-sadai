...
@section('title', 'বাচ্চা/ কাজে সহায়তা  রিপোর্ট')
@section('page_header', 'বাচ্চা/ কাজে সহায়তা  ব্যবস্থাপনা')
@section('helpingHandReport','active')
@section('extracss')
@endsection
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="divform">
                    {{ Form::open(array('url' => 'helpingHandReportListByDate',  'method' => 'post')) }}
                    {{ csrf_field() }}
                    <div class="box-body">
