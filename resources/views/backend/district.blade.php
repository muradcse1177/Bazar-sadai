...
@section('title','জেলা')
@section('page_header', 'জেলা ব্যবস্থাপনা')
@section('mainLiAdd','active menu-open')
@section('disLiAdd','active')
@section('mainDisLiAdd','active menu-open')
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="divform" style="display:none">
                    {{ Form::open(array('url' => 'insertDistrict',  'method' => 'post')) }}
                    {{ csrf_field() }}
                    <div class="box-body">
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">জেলার  লিস্ট </h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body table-responsive">
                    <table class="table table-bordered">
                        ...
                        @foreach($districts as $district)
                            <tr>
                                <td> {{$district-> divName}} </td>
                                <td> {{$district->name}} </td>
                                <td class="td-actions text-center">
                                    <button type="button" rel="tooltip" class="btn btn-success edit" data-id="{{$district->id}}">
                                        <i class="fa fa-edit"></i>
                                    </button>
                                    <button type="button" rel="tooltip"  class="btn btn-danger delete" data-id="{{$district->id}}">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    {{ Form::open(array('url' => 'deleteDistrict',  'method' => 'post')) }}
                                    {{ csrf_field() }}
