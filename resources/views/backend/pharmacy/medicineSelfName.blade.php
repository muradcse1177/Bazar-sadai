...
@section('title', 'সেলফ নাম ')
@section('page_header', 'সেলফ নাম ব্যবস্থাপনা')
@section('medicineSelfName','active')
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="divform" style="display:none">
                    {{ Form::open(array('url' => 'insertMedicineSelf',  'method' => 'post')) }}
                    {{ csrf_field() }}
                    <div class="box-body">
                        <div class="form-group">
                            <label for="">সেলফ নাম </label>
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">সেলফ নাম লিস্ট </h3>
                </div>
                <!-- /.box-header -->
                        ...
                        @foreach($selfNames as $selfName)
                            <tr>
                                ...
                                <td class="td-actions text-center">
                                    <button type="button" rel="tooltip" class="btn btn-success edit" data-id="{{$selfName->id}}">
                                        <i class="fa fa-edit"></i>
                                    </button>
                                    <button type="button" rel="tooltip"  class="btn btn-danger delete" data-id="{{$selfName->id}}">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    {{ Form::open(array('url' => 'deleteMedicineSelf',  'method' => 'post')) }}
                                    {{ csrf_field() }}
