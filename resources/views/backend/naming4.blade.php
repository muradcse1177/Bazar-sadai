...
@section('title','নেমিং ৪')
@section('page_header', 'নেমিং ৪ ব্যবস্থাপনা')
@section('mainLiAdd','active menu-open')
@section('naming4','active')
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="divform" style="display:none">
                    {{ Form::open(array('url' => 'insertNaming4',  'method' => 'post')) }}
                    {{ csrf_field() }}
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for=""> নেমিং ৪  </label>
                            <input type="text" class="form-control name4" id="name4"  name="name4" placeholder="নেমিং ৪ লিখুন" required>
                        </div>
                        <div class="form-group">
                            <label for=""> নাম  </label>
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">ইউনিয়নের  লিস্ট </h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body table-responsive">
                    <table class="table table-bordered">
                        ...
                        @foreach($naming4s as $naming4)
                            <tr>
                                <td> {{$naming4-> divName}} </td>
                                <td> {{$naming4-> disName}} </td>
                                <td> {{$naming4-> upzName}} </td>
                                <td> {{$naming4-> naming4}} </td>
                                <td> {{$naming4->name}} </td>
                                <td class="td-actions text-center">
                                    <button type="button" rel="tooltip" class="btn btn-success edit" data-id="{{$naming4->id}}">
                                        <i class="fa fa-edit"></i>
                                    </button>
                                    <button type="button" rel="tooltip"  class="btn btn-danger delete" data-id="{{$naming4->id}}">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    {{ Form::open(array('url' => 'deleteNaming',  'method' => 'post')) }}
                                    {{ csrf_field() }}
