...
@section('page_header', 'উপজেলা ব্যবস্থাপনা')
@section('mainLiAdd','active menu-open')
@section('upLiAdd','active')
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="divform" style="display:none">
                    {{ Form::open(array('url' => 'insertUpazilla',  'method' => 'post')) }}
                    {{ csrf_field() }}
                    <div class="box-body">
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">উপজেলার  লিস্ট </h3>
                </div>
                <!-- /.box-header -->
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    {{ Form::open(array('url' => 'deleteUpazilla',  'method' => 'post')) }}
                                    {{ csrf_field() }}
