...
@section('page_header', 'ইউনিয়ন ব্যবস্থাপনা')
@section('mainLiAdd','active menu-open')
@section('uniLiAdd','active')
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="divform" style="display:none">
                    {{ Form::open(array('url' => 'insertUnion',  'method' => 'post')) }}
                    {{ csrf_field() }}
                    <div class="box-body">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    {{ Form::open(array('url' => 'deleteUnion',  'method' => 'post')) }}
                                    {{ csrf_field() }}
