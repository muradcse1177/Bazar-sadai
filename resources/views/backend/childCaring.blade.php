...
@section('title','বাচ্চা দেখাশোনা ও কাজে সহায়তা সার্ভিস')
@section('page_header', 'বাচ্চা দেখাশোনা ও কাজে সহায়তা সার্ভিস ব্যবস্থাপনা')
@section('homeAssistantMainLi','active menu-open')
@section('childCaring','active')
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="divform" style="display:none">
                    {{ Form::open(array('url' => 'insertChildCaring',  'method' => 'post')) }}
                    {{ csrf_field() }}
                    <div class="box-body">
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">বাচ্চা দেখাশোনা ও কাজে সহায়তা সার্ভিস  লিস্ট </h3>
                </div>
                <!-- /.box-header -->
                        ...
                        @foreach($childs as $child)
                            <tr>
                                ...
                                <td class="td-actions text-center">
                                    <button type="button" rel="tooltip" class="btn btn-success edit" data-id="{{$child->id}}">
                                        <i class="fa fa-edit"></i>
                                    </button>
                                    <button type="button" rel="tooltip"  class="btn btn-danger delete" data-id="{{$child->id}}">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    {{ Form::open(array('url' => 'deleteChildCaring',  'method' => 'post')) }}
                                    {{ csrf_field() }}
