...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="divform" style="display:none">
                    {{ Form::open(array('url' => 'insertCourierSettings',  'method' => 'post')) }}
                    {{ csrf_field() }}
                    <div class="box-body">
                        <div class="form-group">
                            <label for="">কুরিয়ার ধরণ </label>
                            <select class="form-control select2 c_type" name="c_type" style="width: 100%;" required>
                        ...
                        <div class="form-group">
                            <label for="">ওজন </label>
                            <input type="text" class="form-control weight"  id="weight"  name="weight" placeholder="ওজন লিখুন" required>
                        </div>
                        <div class="form-group">
                            <label for="">খরচ </label>
                            <input type="number" class="form-control cost"  id="cost"  name="cost" placeholder="খরচ লিখুন" required>
                        </div>
                    </div>
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">কুরিয়ার সেটিংস লিস্ট </h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body table-responsive">
                    <table class="table table-bordered">
                        ...
                        @foreach($courierSettings as $courierSetting)
                            <tr>
                                <td> {{$courierSetting->c_name}} </td>
                                <td> {{$courierSetting->name}} </td>
                                <td> {{$courierSetting->weight}} </td>
                                <td> {{$courierSetting->cost}} </td>
                                <td class="td-actions text-center">
                                    <button type="button" rel="tooltip" class="btn btn-success edit" data-id="{{$courierSetting->c_id}}">
                                        <i class="fa fa-edit"></i>
                                    </button>
                                    <button type="button" rel="tooltip"  class="btn btn-danger delete" data-id="{{$courierSetting->c_id}}">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    {{ Form::open(array('url' => 'deleteCourierSetting',  'method' => 'post')) }}
                                    {{ csrf_field() }}
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    for( var i = 0; i<len; i++){
                        ...
                        $(".c_type").append("<option value='"+id+"'>"+name+"</option>");
                    }
